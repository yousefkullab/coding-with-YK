...
public class addNewDepartment extends JFrame implements ActionListener {
	...
	JLabel addNew = new JLabel("Add New Department");
	JLabel name = new JLabel("Name : ");
	JTextField name_txt = new JTextField();
	JLabel description = new JLabel("Description : ");
	JTextArea txtArea = new JTextArea();
	JButton add_btn = new JButton("Add new Department");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == add_btn) {
			setVisible(false);
			JOptionPane.showMessageDialog(this, "Adding Department susscefly");
		}
	}
