...
public class addNewBook extends JFrame implements ActionListener {
	...
	JLabel addNew = new JLabel("Add New Book");
	...
	JButton add_btn = new JButton("New Book");
	...
	public addNewBook() {
		...
		addNew.setBounds(220, 30, 200, 30);
		addNew.setFont(new Font("Comic Sans MS", Font.BOLD, 17));

		add_btn.setBounds(70, 430, 200, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == add_btn) {
			setVisible(false);
			JOptionPane.showMessageDialog(this, "Adding Book susscefly");
		}
